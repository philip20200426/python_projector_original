...
def main():
    ...
    if dev_num is 0:
        ...
        return
    print("Number of enumerated devices is ", dev_num)
    ...
    print('PixelColor is ', cam.PixelColorFilter.is_implemented())
    ...
    img = cv2.imread("G:\python_test\learn_serial\show_pattern.png")
    # # DISPLAY
